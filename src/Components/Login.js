...
const Login = () => {
  ...
  return (
    <div>
        <Header />
        <div className='fixed '> 
        <img  className = "h-screen object-cover w-screen" src={BackgroundImage_URL}
        alt='background' />
        </div>    
        <form onSubmit={(e) => e.preventDefault()}  className=' absolute w-10/12 md:w-3/12 p-12 bg-black my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80 '>
